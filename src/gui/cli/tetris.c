...
void gameLoop() {
  ...
  while (break_flag) {
    ...
    // тут создается впервые статик структура игры и меняются состояния автомата
    // и игровая структура
    userInput(action, hold);
    // тут создается впервые статик структура инфоигры, туда копируются
    // некоторые поля в инфо структуру для отрисовки во фронте
